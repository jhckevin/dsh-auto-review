...
const CSS = `
.ar-controls{border:0;padding:0;margin:0;min-width:0}.ar-controls:disabled{opacity:.65}.ar-page :focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:3px}
...
/* 宿主负责滚动；操作栏参与正常排版，避免遮挡模型和高级设置。 */
.ar-actions{position:static;background:transparent;flex-wrap:wrap;margin-top:12px;border-top:1px solid var(--dsw-alias-border-l1);padding:12px 0 0}
