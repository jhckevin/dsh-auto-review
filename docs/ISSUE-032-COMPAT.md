# ISSUE-032 / GitHub #6: rc6 native lifecycle compatibility

Candidate 0.5.5-rc.2; exact DSH 0.1.0-rc.6. This is a separate historical compatibility branch, not a retag of an old release. All direct and locked DSH packages remain on this one version.
