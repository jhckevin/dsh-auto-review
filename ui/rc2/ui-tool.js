window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region ../../../../tmp/dsh-rc2-badge-proof-20260903/packages/client/ui-tool/src/client/tool/models/tool-call-model.ts
		/**
		...
		*/
		...
		//#endregion
		//#region ../../../../tmp/dsh-rc2-badge-proof-20260903/packages/client/ui-tool/src/client/tool/models/read-card-model.ts
		/**
		...
		*/
		...
		//#endregion
		//#region ../../../../tmp/dsh-rc2-badge-proof-20260903/packages/client/ui-tool/src/client/tool/models/diff-card-model.ts
		/**
		...
		*/
		...
		//#endregion
		//#region ../../../../tmp/dsh-rc2-badge-proof-20260903/packages/client/ui-tool/src/client/tool/models/search-card-model.ts
		/**
		...
		*/
		...
		//#endregion
		//#region ../../../../tmp/dsh-rc2-badge-proof-20260903/packages/client/ui-tool/src/client/tool/models/terminal-card-model.ts
		/**
		...
		*/
		...
		//#endregion
		//#region ../../../../tmp/dsh-rc2-badge-proof-20260903/packages/client/ui-tool/src/client/tool/models/web-card-model.ts
		/**
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/srv/pi-lab-dev/tmp/dsh-rc2-badge-proof-20260903/packages/client/ui-tool/src/client/tool/components/ToolRow.module.css.mjs
		const css$3 = ".EYfJ4W_root{flex-direction:column;display:flex}.EYfJ4W_row{position:relative;overflow:hidden}.EYfJ4W_root[data-state=running] .EYfJ4W_row:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite EYfJ4W_dsh-tool-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes EYfJ4W_dsh-tool-row-sweep{0%{left:-300px}90%,to{left:100%}}.EYfJ4W_leading{flex-shrink:0}.EYfJ4W_root[data-tool^=cordis_] .EYfJ4W_leading,.EYfJ4W_root[data-tool^=cordis_] .EYfJ4W_title{color:var(--dsw-alias-state-business-primary)}.EYfJ4W_root[data-tool^=cordis_] .EYfJ4W_title{font-weight:500}.EYfJ4W_root[data-tool^=cordis_] .EYfJ4W_sep{background:var(--dsw-alias-state-business-primary)}.EYfJ4W_chevron{color:var(--dsw-alias-label-secondary)}.EYfJ4W_title{font-weight:400}.EYfJ4W_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.EYfJ4W_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.EYfJ4W_summarySuffix{white-space:nowrap;color:var(--dsw-alias-label-tertiary);flex:none;margin-left:4px;font-size:14px;line-height:24px}.EYfJ4W_fileLink{text-overflow:ellipsis;white-space:nowrap;min-width:0;font:inherit;text-align:left;color:var(--dsw-alias-label-secondary);text-decoration:underline;text-decoration-color:var(--dsw-alias-label-quaternary);text-underline-offset:3px;cursor:pointer;background:0 0;border:none;flex:auto;margin:0;padding:0;font-size:14px;line-height:24px;overflow:hidden}.EYfJ4W_fileLink:hover{color:var(--dsw-alias-label-primary);text-decoration-color:currentColor}.EYfJ4W_errorSummary{color:var(--dsw-alias-state-error-primary)}.EYfJ4W_bodyWrap{flex-direction:column;display:flex}.EYfJ4W_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.EYfJ4W_root:hover .EYfJ4W_inspectButton,.EYfJ4W_inspectButton:focus-visible{opacity:1}.EYfJ4W_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.EYfJ4W_bodyScroll{max-height:260px;overflow-y:auto}.EYfJ4W_ioCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}.EYfJ4W_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}.EYfJ4W_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.EYfJ4W_ioSection::-webkit-scrollbar-track{margin:6px 0}.EYfJ4W_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}.EYfJ4W_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:1px}.EYfJ4W_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}.EYfJ4W_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}.EYfJ4W_codeBody,.EYfJ4W_terminalBody,.EYfJ4W_diffBody,.EYfJ4W_readBody,.EYfJ4W_searchBody,.EYfJ4W_webBody{margin:4px 0 4px 4px}.EYfJ4W_searchRecovery{white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-xs-13);color:var(--dsw-alias-label-tertiary);margin:4px 0 4px 4px}.EYfJ4W_codeBody{--dsl-code-block-content-font:var(--dsw-font-markdown-code-block-small)}.EYfJ4W_terminalBody{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:1px solid var(--dsw-alias-border-l1)}.EYfJ4W_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var ToolRow_module_css_default = {
			"bodyScroll": "EYfJ4W_bodyScroll",
			"bodyWrap": "EYfJ4W_bodyWrap",
			"chevron": "EYfJ4W_chevron",
			"codeBody": "EYfJ4W_codeBody",
			"diffBody": "EYfJ4W_diffBody",
			"dsh-tool-row-sweep": "EYfJ4W_dsh-tool-row-sweep",
			"errorSummary": "EYfJ4W_errorSummary",
			"fileLink": "EYfJ4W_fileLink",
			"inspectButton": "EYfJ4W_inspectButton",
			"ioCard": "EYfJ4W_ioCard",
			"ioDivider": "EYfJ4W_ioDivider",
			"ioLabel": "EYfJ4W_ioLabel",
			"ioSection": "EYfJ4W_ioSection",
			"ioText": "EYfJ4W_ioText",
			"leading": "EYfJ4W_leading",
			"readBody": "EYfJ4W_readBody",
			"root": "EYfJ4W_root",
			"row": "EYfJ4W_row",
			"searchBody": "EYfJ4W_searchBody",
			"searchRecovery": "EYfJ4W_searchRecovery",
			"sep": "EYfJ4W_sep",
			"summary": "EYfJ4W_summary",
			"summarySuffix": "EYfJ4W_summarySuffix",
			"terminalBody": "EYfJ4W_terminalBody",
			"title": "EYfJ4W_title",
			"visuallyHidden": "EYfJ4W_visuallyHidden",
			"webBody": "EYfJ4W_webBody"
		};
		//#endregion
		//#region ../../../../tmp/dsh-rc2-badge-proof-20260903/packages/client/ui-tool/src/client/tool/components/ToolRow.tsx
		...
		*  summary already describe a settled row). */
		...
		//#endregion
		//#region ../../../../tmp/dsh-rc2-badge-proof-20260903/packages/client/ui-tool/src/client/tool/toolviews/GenericToolCard.tsx
		...
		//#endregion
		//#region \0dsh-css:/srv/pi-lab-dev/tmp/dsh-rc2-badge-proof-20260903/packages/client/ui-tool/src/client/tool/ToolCallTree.module.css.mjs
		const css$2 = ".OY9cxG_callRow{border-radius:6px}.OY9cxG_callLine{align-items:flex-start;display:flex}.OY9cxG_callContent{flex:1;min-width:0}.OY9cxG_badges{flex:none;align-items:center;gap:4px;display:flex}.OY9cxG_badges:empty{display:none}.OY9cxG_subCalls{border-left:1px solid var(--dsw-alias-border-l2);flex-direction:column;gap:4px;margin:4px 0 2px 22px;padding-left:8px;display:flex}";
		...
		var ToolCallTree_module_css_default = {
			"badges": "OY9cxG_badges",
			"callContent": "OY9cxG_callContent",
			"callLine": "OY9cxG_callLine",
			"callRow": "OY9cxG_callRow",
			"subCalls": "OY9cxG_subCalls"
		};
		//#endregion
		//#region ../../../../tmp/dsh-rc2-badge-proof-20260903/packages/client/ui-tool/src/client/tool/ToolCallTree.tsx
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/srv/pi-lab-dev/tmp/dsh-rc2-badge-proof-20260903/packages/client/ui-tool/src/client/tool/ToolDetails.module.css.mjs
		const css$1 = ".uQQd7a_description{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);margin:0 0 6px}.uQQd7a_cardBody{margin:0}.uQQd7a_recovery{white-space:pre-wrap;overflow-wrap:anywhere;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);margin:6px 0 0}.uQQd7a_code{background:var(--dsw-alias-markdown-code-block);font-family:var(--ds-font-family-code);color:var(--dsw-alias-label-primary);white-space:pre-wrap;word-break:break-word;border-radius:12px;margin:0;padding:16px;font-size:13px;line-height:22px}.uQQd7a_code[data-error]{color:var(--dsw-alias-state-error-primary)}.uQQd7a_read,.uQQd7a_web{margin:0}.uQQd7a_empty{color:var(--dsw-alias-label-tertiary);padding:8px 0;font-size:13px;line-height:20px}";
		...
		var ToolDetails_module_css_default = {
			"cardBody": "uQQd7a_cardBody",
			"code": "uQQd7a_code",
			"description": "uQQd7a_description",
			"empty": "uQQd7a_empty",
			"read": "uQQd7a_read",
			"recovery": "uQQd7a_recovery",
			"web": "uQQd7a_web"
		};
		//#endregion
		//#region ../../../../tmp/dsh-rc2-badge-proof-20260903/packages/client/ui-tool/src/client/tool/ToolDetails.tsx
		...
		*/
		...
		//#endregion
		//#region ../../../../tmp/dsh-rc2-badge-proof-20260903/packages/client/ui-tool/src/client/locale.ts
		/** Locale namespace supplied by the conversation owner to Tool renderers. */
		const CONVERSATION_NS = "conversation";
		//#endregion
		//#region ../../../../tmp/dsh-rc2-badge-proof-20260903/packages/client/ui-tool/src/client/tool/toolviews/ask-question-row.tsx
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/srv/pi-lab-dev/tmp/dsh-rc2-badge-proof-20260903/packages/client/ui-tool/src/client/tool/toolviews/bash-sample.module.css.mjs
		const css = "._9B4ETq_card{flex-direction:column;display:flex}._9B4ETq_terminal{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:1px solid var(--dsw-alias-border-l1);margin:4px 0 4px 4px}._9B4ETq_ioCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}._9B4ETq_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}._9B4ETq_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}._9B4ETq_ioSection::-webkit-scrollbar-track{margin:6px 0}._9B4ETq_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}._9B4ETq_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:1px}._9B4ETq_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}._9B4ETq_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}._9B4ETq_root[data-expandable]{cursor:pointer}._9B4ETq_root{align-items:center;min-width:0;height:24px;display:flex;position:relative;overflow:hidden}._9B4ETq_root[data-state=running]:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite _9B4ETq_dsh-bash-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes _9B4ETq_dsh-bash-row-sweep{0%{left:-300px}90%,to{left:100%}}._9B4ETq_leading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:6px;display:inline-flex;position:relative}._9B4ETq_chevron{color:var(--dsw-alias-label-secondary)}._9B4ETq_iconIdle{opacity:1;transition:opacity .1s;display:inline-flex}._9B4ETq_chevronHover{opacity:0;margin:auto;transition:opacity .1s;position:absolute;inset:0}._9B4ETq_root:hover ._9B4ETq_iconIdle{opacity:0}._9B4ETq_root:hover ._9B4ETq_chevronHover{opacity:1}._9B4ETq_title{color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px}._9B4ETq_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}._9B4ETq_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}._9B4ETq_errorSummary{color:var(--dsw-alias-state-error-primary)}._9B4ETq_bodyWrap{flex-direction:column;display:flex}._9B4ETq_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}._9B4ETq_card:hover ._9B4ETq_inspectButton,._9B4ETq_inspectButton:focus-visible{opacity:1}._9B4ETq_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}._9B4ETq_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var bash_sample_module_css_default = {
			"bodyWrap": "_9B4ETq_bodyWrap",
			"card": "_9B4ETq_card",
			"chevron": "_9B4ETq_chevron",
			"chevronHover": "_9B4ETq_chevronHover",
			"dsh-bash-row-sweep": "_9B4ETq_dsh-bash-row-sweep",
			"errorSummary": "_9B4ETq_errorSummary",
			"iconIdle": "_9B4ETq_iconIdle",
			"inspectButton": "_9B4ETq_inspectButton",
			"ioCard": "_9B4ETq_ioCard",
			"ioDivider": "_9B4ETq_ioDivider",
			"ioLabel": "_9B4ETq_ioLabel",
			"ioSection": "_9B4ETq_ioSection",
			"ioText": "_9B4ETq_ioText",
			"leading": "_9B4ETq_leading",
			"root": "_9B4ETq_root",
			"sep": "_9B4ETq_sep",
			"summary": "_9B4ETq_summary",
			"terminal": "_9B4ETq_terminal",
			"title": "_9B4ETq_title",
			"visuallyHidden": "_9B4ETq_visuallyHidden"
		};
		//#endregion
		//#region ../../../../tmp/dsh-rc2-badge-proof-20260903/packages/client/ui-tool/src/client/tool/toolviews/bash-sample.tsx
		...
		*/
		...
		//#endregion
		//#region ../../../../tmp/dsh-rc2-badge-proof-20260903/packages/client/ui-tool/src/client/tool/toolviews/file-mutation-row.tsx
		/**
		...
		*/
		...
		//#endregion
		//#region ../../../../tmp/dsh-rc2-badge-proof-20260903/packages/client/ui-tool/src/client/tool/toolviews/read-row.tsx
		/**
		...
		*/
		...
		//#endregion
		//#region ../../../../tmp/dsh-rc2-badge-proof-20260903/packages/client/ui-tool/src/client/tool/toolviews/search-row.tsx
		const SEARCH_TITLES = {
			grep: "Grep",
			glob: "Glob"
		};
		...
		*/
		...
		//#endregion
		//#region ../../../../tmp/dsh-rc2-badge-proof-20260903/packages/client/ui-tool/src/client/tool/toolviews/plan-summary.ts
		/**
		...
		*/
		...
		//#endregion
		//#region ../../../../tmp/dsh-rc2-badge-proof-20260903/packages/client/ui-tool/src/client/tool/toolviews/todo-row.tsx
		...
		*/
		...
		//#endregion
		//#region ../../../../tmp/dsh-rc2-badge-proof-20260903/packages/client/ui-tool/src/client/tool/toolviews/web-row.tsx
		...
		*/
		...
		//#endregion
		//#region ../../../../tmp/dsh-rc2-badge-proof-20260903/packages/client/ui-tool/src/client/apply.ts
