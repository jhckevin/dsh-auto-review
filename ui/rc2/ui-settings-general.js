window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:/srv/pi-lab-dev/tmp/dsh-rc2-badge-proof-20260903/packages/client/ui-settings-general/src/client/SettingsRoot.module.css.mjs
		const css$3 = "._9W6BYq_trigger{box-sizing:border-box;cursor:pointer;width:calc(100% + 4px);height:42px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:12px;flex:none;align-items:center;gap:8px;margin:4px -2px;padding:0 10px 0 8px;font-family:inherit;font-size:14px;line-height:22px;display:flex;overflow:hidden}._9W6BYq_trigger:hover{background:var(--dsw-alias-interactive-bg-hover)}._9W6BYq_trigger._9W6BYq_rail{border-radius:50%;justify-content:center;gap:0;width:36px;height:36px;margin:8px 0 10px;padding:0}._9W6BYq_triggerLabel{white-space:nowrap;overflow:hidden}._9W6BYq_overlay{z-index:1000;justify-content:center;align-items:center;display:flex;position:fixed;inset:0}._9W6BYq_mask{background:var(--dsw-alias-bg-mask-1);backdrop-filter:var(--dsw-mask-blur);position:absolute;inset:0}._9W6BYq_panel{z-index:1;background:var(--dsw-alias-bg-layer-2);width:800px;max-width:calc(100vw - 48px);height:min(800px,100vh - 48px);box-shadow:var(--dsw-shadow-lv3);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:24px;display:flex;position:relative;overflow:hidden}._9W6BYq_nav{box-sizing:border-box;flex-direction:column;flex:none;gap:18px;width:188px;padding:22px 12px 0;display:flex}._9W6BYq_navTitle{color:var(--dsw-alias-label-primary);padding:0 12px;font-size:16px;font-weight:500;line-height:24px}._9W6BYq_navList{flex-direction:column;gap:4px;display:flex}._9W6BYq_navCell{box-sizing:border-box;cursor:pointer;height:40px;color:var(--dsw-alias-label-primary);text-align:left;background:0 0;border:none;border-radius:12px;align-items:center;gap:8px;padding:9px 16px 9px 12px;font-family:inherit;font-size:14px;font-weight:400;line-height:22px;display:flex}._9W6BYq_navCell:hover{background:var(--dsw-specific-sidebar-nav-item-hover)}._9W6BYq_navCell._9W6BYq_active{background:var(--dsw-specific-sidebar-nav-item-active)}._9W6BYq_navIcon{flex:none}._9W6BYq_navLabel{white-space:nowrap;text-overflow:ellipsis;flex:1;min-width:0;overflow:hidden}._9W6BYq_content{flex-direction:column;flex:1;min-width:0;display:flex}._9W6BYq_header{box-sizing:border-box;flex:none;justify-content:space-between;align-items:flex-start;gap:8px;height:54px;padding:20px 14px 8px 10px;display:flex}._9W6BYq_actions{justify-content:flex-end;align-items:center;gap:8px;min-width:0;margin-left:auto;display:flex}._9W6BYq_close{cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:28px;justify-content:center;align-items:center;padding:0;display:inline-flex}._9W6BYq_close:hover{background:var(--dsw-alias-interactive-bg-hover)}._9W6BYq_options{flex:1;min-height:0;padding:0 24px 24px;overflow-y:auto}._9W6BYq_hiddenLabel{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var SettingsRoot_module_css_default = {
			"actions": "_9W6BYq_actions",
			"active": "_9W6BYq_active",
			"close": "_9W6BYq_close",
			"content": "_9W6BYq_content",
			"header": "_9W6BYq_header",
			"hiddenLabel": "_9W6BYq_hiddenLabel",
			"mask": "_9W6BYq_mask",
			"nav": "_9W6BYq_nav",
			"navCell": "_9W6BYq_navCell",
			"navIcon": "_9W6BYq_navIcon",
			"navLabel": "_9W6BYq_navLabel",
			"navList": "_9W6BYq_navList",
			"navTitle": "_9W6BYq_navTitle",
			"options": "_9W6BYq_options",
			"overlay": "_9W6BYq_overlay",
			"panel": "_9W6BYq_panel",
			"rail": "_9W6BYq_rail",
			"trigger": "_9W6BYq_trigger",
			"triggerLabel": "_9W6BYq_triggerLabel"
		};
		//#endregion
		//#region ../../../../tmp/dsh-rc2-badge-proof-20260903/packages/client/ui-settings-general/src/client/SettingsRoot.tsx
		/**
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/srv/pi-lab-dev/tmp/dsh-rc2-badge-proof-20260903/packages/client/ui-settings-general/src/client/chrome.module.css.mjs
		const css$2 = ".IgpLBq_triggerLabel{white-space:nowrap;overflow:hidden}";
		...
		var chrome_module_css_default = { "triggerLabel": "IgpLBq_triggerLabel" };
		//#endregion
		//#region ../../../../tmp/dsh-rc2-badge-proof-20260903/packages/client/ui-settings-general/src/client/chrome.tsx
		/**
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/srv/pi-lab-dev/tmp/dsh-rc2-badge-proof-20260903/packages/client/ui-settings-general/src/client/GeneralSection.module.css.mjs
		const css$1 = ".wR5POq_section{flex-direction:column;width:100%;display:flex}.wR5POq_section>[data-slot=\"settings.general.item\"]>:last-child{border-bottom:none}";
		...
		var GeneralSection_module_css_default = { "section": "wR5POq_section" };
		//#endregion
		//#region ../../../../tmp/dsh-rc2-badge-proof-20260903/packages/client/ui-settings-general/src/client/GeneralSection.tsx
		/**
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/srv/pi-lab-dev/tmp/dsh-rc2-badge-proof-20260903/packages/client/ui-settings-general/src/client/SettingsDocumentAction.module.css.mjs
		const css = ".df73TG_action{align-items:center;gap:8px;min-width:0;display:flex}.df73TG_error{max-width:180px;color:var(--dsw-alias-state-error-primary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}";
		...
		var SettingsDocumentAction_module_css_default = {
			"action": "df73TG_action",
			"error": "df73TG_error"
		};
		//#endregion
		//#region ../../../../tmp/dsh-rc2-badge-proof-20260903/packages/client/ui-settings-general/src/client/SettingsDocumentAction.tsx
		...
		*/
		...
		//#endregion
		//#region ../../../../tmp/dsh-rc2-badge-proof-20260903/packages/client/ui-settings-general/src/client/settings-document-store.ts
		...
		//#endregion
		//#region ../../../../tmp/dsh-rc2-badge-proof-20260903/packages/client/ui-settings-general/src/client/locales.ts
		...
		//#endregion
		//#region ../../../../tmp/dsh-rc2-badge-proof-20260903/packages/client/ui-settings-general/src/client/index.ts
