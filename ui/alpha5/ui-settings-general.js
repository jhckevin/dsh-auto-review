window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:/srv/pi-lab-dev/tmp/dsh-alpha5-badge-proof-20260903/packages/client/ui-settings-general/src/client/SettingsRoot.module.css.mjs
		const css$3 = ".c3TGFa_triggerRow{flex:none;align-items:center;gap:8px;width:calc(100% + 4px);margin:4px -2px;display:flex}.c3TGFa_triggerRow.c3TGFa_railRow{width:36px;margin:8px 0 10px}.c3TGFa_trigger{box-sizing:border-box;cursor:pointer;width:auto;min-width:0;height:42px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:12px;flex:1;align-items:center;gap:8px;margin:0;padding:0 10px 0 8px;font-family:inherit;font-size:14px;line-height:22px;display:flex;overflow:hidden}.c3TGFa_trigger:hover{background:var(--dsw-alias-interactive-bg-hover)}.c3TGFa_trigger.c3TGFa_rail{corner-shape:round;border-radius:50%;flex:none;justify-content:center;gap:0;width:36px;height:36px;margin:0;padding:0}.c3TGFa_triggerLabel{white-space:nowrap;overflow:hidden}.c3TGFa_overlay{z-index:1000;justify-content:center;align-items:center;display:flex;position:fixed;inset:0}.c3TGFa_mask{background:var(--dsw-alias-bg-mask-1);backdrop-filter:var(--dsw-mask-blur);position:absolute;inset:0}.c3TGFa_panel{z-index:1;background:var(--dsw-alias-bg-layer-2);width:800px;max-width:calc(100vw - 48px);height:min(800px,100vh - 48px);box-shadow:var(--dsw-elevation-prominent);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:32px;display:flex;position:relative;overflow:hidden}.c3TGFa_nav{box-sizing:border-box;flex-direction:column;flex:none;gap:18px;width:188px;padding:22px 12px 0;display:flex}.c3TGFa_navTitle{color:var(--dsw-alias-label-primary);padding:0 12px;font-size:16px;font-weight:500;line-height:24px}.c3TGFa_navList{flex-direction:column;gap:4px;display:flex}.c3TGFa_navCell{box-sizing:border-box;cursor:pointer;height:40px;color:var(--dsw-alias-label-primary);text-align:left;background:0 0;border:none;border-radius:12px;align-items:center;gap:8px;padding:9px 16px 9px 12px;font-family:inherit;font-size:14px;font-weight:400;line-height:22px;display:flex}.c3TGFa_navCell:hover{background:var(--dsw-specific-sidebar-nav-item-hover)}.c3TGFa_navCell.c3TGFa_active{background:var(--dsw-specific-sidebar-nav-item-active)}.c3TGFa_navIcon{flex:none}.c3TGFa_navLabel{white-space:nowrap;text-overflow:ellipsis;flex:1;min-width:0;overflow:hidden}.c3TGFa_content{flex-direction:column;flex:1;min-width:0;display:flex}.c3TGFa_header{box-sizing:border-box;flex:none;justify-content:space-between;align-items:flex-start;gap:8px;height:54px;padding:20px 14px 8px 10px;display:flex}.c3TGFa_actions{justify-content:flex-end;align-items:center;gap:8px;min-width:0;margin-left:auto;display:flex}.c3TGFa_close{cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:28px;justify-content:center;align-items:center;padding:0;display:inline-flex}.c3TGFa_close:hover{background:var(--dsw-alias-interactive-bg-hover)}.c3TGFa_options{flex:1;min-height:0;padding:0 24px 24px;overflow-y:auto}.c3TGFa_hiddenLabel{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var SettingsRoot_module_css_default = {
			"actions": "c3TGFa_actions",
			"active": "c3TGFa_active",
			"close": "c3TGFa_close",
			"content": "c3TGFa_content",
			"header": "c3TGFa_header",
			"hiddenLabel": "c3TGFa_hiddenLabel",
			"mask": "c3TGFa_mask",
			"nav": "c3TGFa_nav",
			"navCell": "c3TGFa_navCell",
			"navIcon": "c3TGFa_navIcon",
			"navLabel": "c3TGFa_navLabel",
			"navList": "c3TGFa_navList",
			"navTitle": "c3TGFa_navTitle",
			"options": "c3TGFa_options",
			"overlay": "c3TGFa_overlay",
			"panel": "c3TGFa_panel",
			"rail": "c3TGFa_rail",
			"railRow": "c3TGFa_railRow",
			"trigger": "c3TGFa_trigger",
			"triggerLabel": "c3TGFa_triggerLabel",
			"triggerRow": "c3TGFa_triggerRow"
		};
		//#endregion
		//#region ../../../../../tmp/dsh-alpha5-badge-proof-20260903/packages/client/ui-settings-general/src/client/SettingsRoot.tsx
		/**
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("nav", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							children: rows.map((row) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
								...
								children: [renderSlot("settings.section.icon", { sectionId: row.id }, {
									entryKey: row.id,
		...
		*/
		function SettingsRoot(props) {
			...
			const completeOnboardingStep = (0, react.useCallback)((id) => {
				setCompletedOnboarding((previous) => {
					...
					return /* @__PURE__ */ new Set([...previous, id]);
				});
			}, []);
		...
		//#endregion
		//#region \0dsh-css:/srv/pi-lab-dev/tmp/dsh-alpha5-badge-proof-20260903/packages/client/ui-settings-general/src/client/chrome.module.css.mjs
		const css$2 = ".Y_BrAa_triggerLabel{white-space:nowrap;overflow:hidden}";
		...
		var chrome_module_css_default = { "triggerLabel": "Y_BrAa_triggerLabel" };
		//#endregion
		//#region ../../../../../tmp/dsh-alpha5-badge-proof-20260903/packages/client/ui-settings-general/src/client/chrome.tsx
		/**
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/srv/pi-lab-dev/tmp/dsh-alpha5-badge-proof-20260903/packages/client/ui-settings-general/src/client/GeneralSection.module.css.mjs
		const css$1 = ".lx20oG_section{flex-direction:column;width:100%;display:flex}.lx20oG_section>[data-slot=\"settings.general.item\"]>:last-child{border-bottom:none}";
		...
		var GeneralSection_module_css_default = { "section": "lx20oG_section" };
		//#endregion
		//#region ../../../../../tmp/dsh-alpha5-badge-proof-20260903/packages/client/ui-settings-general/src/client/GeneralSection.tsx
		/**
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/srv/pi-lab-dev/tmp/dsh-alpha5-badge-proof-20260903/packages/client/ui-settings-general/src/client/SettingsDocumentAction.module.css.mjs
		const css = "._9RKBuq_action{align-items:center;gap:8px;min-width:0;display:flex}._9RKBuq_error{max-width:180px;color:var(--dsw-alias-state-error-primary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}";
		...
		var SettingsDocumentAction_module_css_default = {
			"action": "_9RKBuq_action",
			"error": "_9RKBuq_error"
		};
		//#endregion
		//#region ../../../../../tmp/dsh-alpha5-badge-proof-20260903/packages/client/ui-settings-general/src/client/SettingsDocumentAction.tsx
		...
		*/
		...
		//#endregion
		//#region ../../../../../tmp/dsh-alpha5-badge-proof-20260903/packages/client/ui-settings-general/src/client/settings-document-store.ts
		...
		//#endregion
		//#region ../../../../../tmp/dsh-alpha5-badge-proof-20260903/packages/client/ui-settings-general/src/client/locales.ts
		...
		//#endregion
		//#region ../../../../../tmp/dsh-alpha5-badge-proof-20260903/packages/client/ui-settings-general/src/client/index.ts
