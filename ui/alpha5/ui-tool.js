window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region ../../../../../tmp/npm-public-cold-alpha5-20260905/node_modules/@deepseek-ai/dsh-util-workspace-path/lib/index.js
		/**
		...
		*/
		...
		//#endregion
		//#region ../../../../../tmp/dsh-alpha5-badge-proof-20260903/packages/client/ui-tool/src/client/tool/models/tool-call-model.ts
		...
		*/
		...
		//#endregion
		//#region ../../../../../tmp/dsh-alpha5-badge-proof-20260903/packages/client/ui-tool/src/client/tool/models/raw-tool-call.ts
		...
		*/
		...
		//#endregion
		//#region ../../../../../tmp/dsh-alpha5-badge-proof-20260903/packages/client/ui-tool/src/client/tool/models/read-card-model.ts
		...
		*/
		...
		//#endregion
		//#region ../../../../../tmp/dsh-alpha5-badge-proof-20260903/packages/client/ui-tool/src/client/tool/models/diff-card-model.ts
		/**
		...
		*/
		...
		//#endregion
		//#region ../../../../../tmp/dsh-alpha5-badge-proof-20260903/packages/client/ui-tool/src/client/tool/models/search-card-model.ts
		...
		*/
		...
		//#endregion
		//#region ../../../../../tmp/dsh-alpha5-badge-proof-20260903/packages/client/ui-tool/src/client/tool/models/terminal-card-model.ts
		/**
		...
		*/
		...
		//#endregion
		//#region ../../../../../tmp/dsh-alpha5-badge-proof-20260903/packages/client/ui-tool/src/client/tool/models/web-card-model.ts
		...
		*/
		...
		//#endregion
		//#region ../../../../dsh-auto-review-universal-alpha/node_modules/clsx/dist/clsx.mjs
		function r(e) {
			var t, f, n = "";
		...
		//#endregion
		//#region ../../../../../tmp/dsh-alpha5-badge-proof-20260903/packages/client/ui-tool/src/client/tool/models/primitive-labels.ts
		/**
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/srv/pi-lab-dev/tmp/dsh-alpha5-badge-proof-20260903/packages/client/ui-tool/src/client/tool/components/AskQuestionCard.module.css.mjs
		const css$4 = ".FCtwKG_card{border:.5px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-base);border-radius:12px;flex-direction:column;gap:16px;max-height:360px;margin:4px 0 4px 4px;padding:16px 20px;display:flex;overflow-y:auto}.FCtwKG_item{flex-direction:column;gap:2px;min-width:0;display:flex}.FCtwKG_question,.FCtwKG_answer{white-space:pre-wrap;overflow-wrap:anywhere;font-size:var(--dsh-content-font-size,14px);line-height:calc(24px + var(--dsh-content-font-delta,0px));margin:0}.FCtwKG_question{color:var(--dsw-alias-label-tertiary)}.FCtwKG_answer{color:var(--dsw-alias-label-primary)}.FCtwKG_answerLine{display:block}.FCtwKG_skipped{color:var(--dsw-alias-label-tertiary)}.FCtwKG_verdict{color:var(--dsw-alias-label-primary);font-size:var(--dsh-content-font-size,14px);line-height:calc(24px + var(--dsh-content-font-delta,0px));margin:0}.FCtwKG_questionList{flex-direction:column;gap:8px;margin:0;padding-left:20px;display:flex}.FCtwKG_unansweredQuestion{color:var(--dsw-alias-label-tertiary);white-space:pre-wrap;overflow-wrap:anywhere;font-size:var(--dsh-content-font-size,14px);line-height:calc(24px + var(--dsh-content-font-delta,0px))}";
		...
		var AskQuestionCard_module_css_default = {
			"answer": "FCtwKG_answer",
			"answerLine": "FCtwKG_answerLine",
			"card": "FCtwKG_card",
			"item": "FCtwKG_item",
			"question": "FCtwKG_question",
			"questionList": "FCtwKG_questionList",
			"skipped": "FCtwKG_skipped",
			"unansweredQuestion": "FCtwKG_unansweredQuestion",
			"verdict": "FCtwKG_verdict"
		};
		//#endregion
		//#region ../../../../../tmp/dsh-alpha5-badge-proof-20260903/packages/client/ui-tool/src/client/tool/components/AskQuestionCard.tsx
		/**
		...
		*/
		function AskQuestionCard({ card }) {
			if (card.kind === "unanswered") return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
					...
					children: card.questions.map((question) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("li", {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("dl", {
				className: AskQuestionCard_module_css_default.card,
				children: card.questions.map((question) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("dt", {
						...
						children: question.answers.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: AskQuestionCard_module_css_default.skipped,
							children: card.skippedLabel
						}) : question.answers.map((answer, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
		...
		//#endregion
		//#region \0dsh-css:/srv/pi-lab-dev/tmp/dsh-alpha5-badge-proof-20260903/packages/client/ui-tool/src/client/tool/components/ToolRow.module.css.mjs
		const css$3 = ".ldVMpG_root{flex-direction:column;display:flex}.ldVMpG_row{position:relative;overflow:hidden}.ldVMpG_root[data-state=running] .ldVMpG_row:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite ldVMpG_dsh-tool-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes ldVMpG_dsh-tool-row-sweep{0%{left:-300px}90%,to{left:100%}}.ldVMpG_leading{flex-shrink:0}.ldVMpG_root[data-tool^=cordis_] .ldVMpG_leading,.ldVMpG_root[data-tool^=cordis_] .ldVMpG_title{color:var(--dsw-alias-state-business-primary)}.ldVMpG_root[data-tool^=cordis_] .ldVMpG_title{font-weight:500}.ldVMpG_root[data-tool^=cordis_] .ldVMpG_sep{background:var(--dsw-alias-state-business-primary)}.ldVMpG_chevron{color:var(--dsw-alias-label-secondary)}.ldVMpG_title{font-weight:400}.ldVMpG_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.ldVMpG_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);flex:auto;overflow:hidden}.ldVMpG_summarySuffix{white-space:nowrap;font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);flex:none;margin-left:4px}.ldVMpG_diffStat{font-family:var(--ds-font-family-code);font-size:calc(var(--dsh-content-font-size-secondary,13px) - 2px);color:var(--dsw-alias-label-caption);margin-left:10px;transform:translateY(.5px)}.ldVMpG_fileLink{text-overflow:ellipsis;white-space:nowrap;min-width:0;font:inherit;text-align:left;font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-secondary);text-decoration:underline dotted;text-decoration-color:var(--dsw-alias-label-tertiary);text-underline-offset:3px;cursor:pointer;background:0 0;border:none;flex:0 auto;margin:0;padding:0;text-decoration-thickness:1px;overflow:hidden}.ldVMpG_fileLink:hover{color:var(--dsw-alias-label-primary);text-decoration-color:currentColor}.ldVMpG_errorSummary{color:var(--dsw-alias-state-error-primary)}.ldVMpG_bodyWrap{flex-direction:column;display:flex}.ldVMpG_inspectButton{border:.5px solid var(--dsw-alias-border-l3);corner-shape:round;background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.ldVMpG_root:hover .ldVMpG_inspectButton,.ldVMpG_inspectButton:focus-visible{opacity:1}.ldVMpG_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.ldVMpG_bodyScroll{max-height:260px;overflow-y:auto}.ldVMpG_ioCard{border:.5px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}.ldVMpG_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}.ldVMpG_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.ldVMpG_ioSection::-webkit-scrollbar-track{margin:6px 0}.ldVMpG_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}.ldVMpG_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:.5px}.ldVMpG_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}.ldVMpG_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}.ldVMpG_codeBody,.ldVMpG_terminalBody,.ldVMpG_diffBody,.ldVMpG_readBody,.ldVMpG_searchBody,.ldVMpG_webBody{margin:4px 0 4px 4px}.ldVMpG_searchRecovery{white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-xs-13);color:var(--dsw-alias-label-tertiary);margin:4px 0 4px 4px}.ldVMpG_codeBody{--dsl-code-block-content-font:var(--dsw-font-markdown-code-block-small)}.ldVMpG_terminalBody{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:.5px solid var(--dsw-alias-border-l1)}.ldVMpG_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var ToolRow_module_css_default = {
			"bodyScroll": "ldVMpG_bodyScroll",
			"bodyWrap": "ldVMpG_bodyWrap",
			"chevron": "ldVMpG_chevron",
			"codeBody": "ldVMpG_codeBody",
			"diffBody": "ldVMpG_diffBody",
			"diffStat": "ldVMpG_diffStat",
			"dsh-tool-row-sweep": "ldVMpG_dsh-tool-row-sweep",
			"errorSummary": "ldVMpG_errorSummary",
			"fileLink": "ldVMpG_fileLink",
			"inspectButton": "ldVMpG_inspectButton",
			"ioCard": "ldVMpG_ioCard",
			"ioDivider": "ldVMpG_ioDivider",
			"ioLabel": "ldVMpG_ioLabel",
			"ioSection": "ldVMpG_ioSection",
			"ioText": "ldVMpG_ioText",
			"leading": "ldVMpG_leading",
			"readBody": "ldVMpG_readBody",
			"root": "ldVMpG_root",
			"row": "ldVMpG_row",
			"searchBody": "ldVMpG_searchBody",
			"searchRecovery": "ldVMpG_searchRecovery",
			"sep": "ldVMpG_sep",
			"summary": "ldVMpG_summary",
			"summarySuffix": "ldVMpG_summarySuffix",
			"terminalBody": "ldVMpG_terminalBody",
			"title": "ldVMpG_title",
			"visuallyHidden": "ldVMpG_visuallyHidden",
			"webBody": "ldVMpG_webBody"
		};
		//#endregion
		//#region ../../../../../tmp/dsh-alpha5-badge-proof-20260903/packages/client/ui-tool/src/client/tool/components/ToolRow.tsx
		...
		*  summary already describe a settled row). */
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [status !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
					...
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [askQuestionBody !== null ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(AskQuestionCard, { card: askQuestionBody }) : terminalBody !== null ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.TerminalBlock, {
							...terminalBody.card,
							maxLines: Infinity,
						...
						}) : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [variant === "code" && bodyText !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		...
		//#endregion
		//#region ../../../../../tmp/dsh-alpha5-badge-proof-20260903/packages/client/ui-tool/src/client/tool/toolviews/GenericToolCard.tsx
		...
		//#endregion
		//#region \0dsh-css:/srv/pi-lab-dev/tmp/dsh-alpha5-badge-proof-20260903/packages/client/ui-tool/src/client/tool/ToolCallTree.module.css.mjs
		const css$2 = ".OcVnKW_callRow{border-radius:6px}.OcVnKW_callLine{align-items:flex-start;display:flex}.OcVnKW_callContent{flex:1;min-width:0}.OcVnKW_badges{flex:none;align-items:center;gap:4px;display:flex}.OcVnKW_badges:empty{display:none}.OcVnKW_subCalls{border-left:.5px solid var(--dsw-alias-border-l2);flex-direction:column;gap:4px;margin:4px 0 2px 22px;padding-left:8px;display:flex}";
		...
		var ToolCallTree_module_css_default = {
			"badges": "OcVnKW_badges",
			"callContent": "OcVnKW_callContent",
			"callLine": "OcVnKW_callLine",
			"callRow": "OcVnKW_callRow",
			"subCalls": "OcVnKW_subCalls"
		};
		//#endregion
		//#region ../../../../../tmp/dsh-alpha5-badge-proof-20260903/packages/client/ui-tool/src/client/tool/ToolCallTree.tsx
		...
		const ToolCall = (0, react.memo)(function ToolCall({ renderSlot, callId, toolName, block, openFile, selected, cwd, home, inspectCall, t, children }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: ToolCallTree_module_css_default.callLine,
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: ToolCallTree_module_css_default.callContent,
						...
						className: ToolCallTree_module_css_default.badges,
						children: renderSlot("tool.call.badges", {
							callId,
							toolName
						})
					})]
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/srv/pi-lab-dev/tmp/dsh-alpha5-badge-proof-20260903/packages/client/ui-tool/src/client/tool/ToolDetails.module.css.mjs
		const css$1 = ".c2gDwa_description{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);margin:0 0 6px}.c2gDwa_cardBody{margin:0}.c2gDwa_recovery{white-space:pre-wrap;overflow-wrap:anywhere;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);margin:6px 0 0}.c2gDwa_code{background:var(--dsw-alias-markdown-code-block);font-family:var(--ds-font-family-code);color:var(--dsw-alias-label-primary);white-space:pre-wrap;word-break:break-word;border-radius:12px;margin:0;padding:16px;font-size:13px;line-height:22px}.c2gDwa_code[data-error]{color:var(--dsw-alias-state-error-primary)}.c2gDwa_read,.c2gDwa_web{margin:0}.c2gDwa_empty{color:var(--dsw-alias-label-tertiary);padding:8px 0;font-size:13px;line-height:20px}";
		...
		var ToolDetails_module_css_default = {
			"cardBody": "c2gDwa_cardBody",
			"code": "c2gDwa_code",
			"description": "c2gDwa_description",
			"empty": "c2gDwa_empty",
			"read": "c2gDwa_read",
			"recovery": "c2gDwa_recovery",
			"web": "c2gDwa_web"
		};
		//#endregion
		//#region ../../../../../tmp/dsh-alpha5-badge-proof-20260903/packages/client/ui-tool/src/client/tool/ToolDetails.tsx
		...
		*/
		function ToolDetails({ block, cwd, useHostInfo, t }) {
			...
			if (terminalModel !== null) {
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [terminal.description !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		...
		//#endregion
		//#region ../../../../../tmp/dsh-alpha5-badge-proof-20260903/packages/client/ui-tool/src/client/locale.ts
		/** Locale namespace supplied by the conversation owner to Tool renderers. */
		const CONVERSATION_NS = "conversation";
		//#endregion
		//#region ../../../../../tmp/dsh-alpha5-badge-proof-20260903/packages/client/ui-tool/src/client/tool/toolviews/ask-question-row.tsx
		...
		//#endregion
		//#region \0dsh-css:/srv/pi-lab-dev/tmp/dsh-alpha5-badge-proof-20260903/packages/client/ui-tool/src/client/tool/toolviews/bash-sample.module.css.mjs
		const css = ".WMt7Bq_card{flex-direction:column;display:flex}.WMt7Bq_terminal{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:.5px solid var(--dsw-alias-border-l1);margin:4px 0 4px 4px}.WMt7Bq_ioCard{border:.5px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}.WMt7Bq_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}.WMt7Bq_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.WMt7Bq_ioSection::-webkit-scrollbar-track{margin:6px 0}.WMt7Bq_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}.WMt7Bq_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:.5px}.WMt7Bq_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}.WMt7Bq_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}.WMt7Bq_root[data-expandable]{cursor:pointer}.WMt7Bq_root{height:calc(24px + var(--dsh-content-font-delta,0px));align-items:center;min-width:0;display:flex;position:relative;overflow:hidden}.WMt7Bq_root[data-state=running]:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite WMt7Bq_dsh-bash-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes WMt7Bq_dsh-bash-row-sweep{0%{left:-300px}90%,to{left:100%}}.WMt7Bq_leading{width:calc(16px + var(--dsh-content-font-delta,0px));height:calc(16px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:6px;display:inline-flex;position:relative}.WMt7Bq_leading svg:not([data-state]){width:calc(14px + var(--dsh-content-font-delta,0px));height:calc(14px + var(--dsh-content-font-delta,0px))}.WMt7Bq_chevron{color:var(--dsw-alias-label-secondary)}.WMt7Bq_iconIdle{opacity:1;transition:opacity .1s;display:inline-flex}.WMt7Bq_chevronHover{opacity:0;margin:auto;transition:opacity .1s;position:absolute;inset:0}.WMt7Bq_root:hover .WMt7Bq_iconIdle{opacity:0}.WMt7Bq_root:hover .WMt7Bq_chevronHover{opacity:1}.WMt7Bq_title{font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-secondary);flex:none}.WMt7Bq_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.WMt7Bq_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:var(--dsh-content-font-size-secondary,13px);line-height:calc(24px + var(--dsh-content-font-delta,0px));color:var(--dsw-alias-label-tertiary);flex:auto;overflow:hidden}.WMt7Bq_errorSummary{color:var(--dsw-alias-state-error-primary)}.WMt7Bq_bodyWrap{flex-direction:column;display:flex}.WMt7Bq_inspectButton{border:.5px solid var(--dsw-alias-border-l4);corner-shape:round;background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.WMt7Bq_card:hover .WMt7Bq_inspectButton,.WMt7Bq_inspectButton:focus-visible{opacity:1}.WMt7Bq_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.WMt7Bq_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var bash_sample_module_css_default = {
			"bodyWrap": "WMt7Bq_bodyWrap",
			"card": "WMt7Bq_card",
			"chevron": "WMt7Bq_chevron",
			"chevronHover": "WMt7Bq_chevronHover",
			"dsh-bash-row-sweep": "WMt7Bq_dsh-bash-row-sweep",
			"errorSummary": "WMt7Bq_errorSummary",
			"iconIdle": "WMt7Bq_iconIdle",
			"inspectButton": "WMt7Bq_inspectButton",
			"ioCard": "WMt7Bq_ioCard",
			"ioDivider": "WMt7Bq_ioDivider",
			"ioLabel": "WMt7Bq_ioLabel",
			"ioSection": "WMt7Bq_ioSection",
			"ioText": "WMt7Bq_ioText",
			"leading": "WMt7Bq_leading",
			"root": "WMt7Bq_root",
			"sep": "WMt7Bq_sep",
			"summary": "WMt7Bq_summary",
			"terminal": "WMt7Bq_terminal",
			"title": "WMt7Bq_title",
			"visuallyHidden": "WMt7Bq_visuallyHidden"
		};
		//#endregion
		//#region ../../../../../tmp/dsh-alpha5-badge-proof-20260903/packages/client/ui-tool/src/client/tool/toolviews/bash-sample.tsx
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [terminal !== null ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.TerminalBlock, {
						...
						children: [
							...
							body !== null && model.output !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
		...
		//#endregion
		//#region ../../../../../tmp/dsh-alpha5-badge-proof-20260903/packages/client/ui-tool/src/client/tool/toolviews/file-mutation-row.tsx
		/**
		...
		*/
		...
		//#endregion
		//#region ../../../../../tmp/dsh-alpha5-badge-proof-20260903/packages/client/ui-tool/src/client/tool/toolviews/read-row.tsx
		/**
		...
		*/
		...
		//#endregion
		//#region ../../../../../tmp/dsh-alpha5-badge-proof-20260903/packages/client/ui-tool/src/client/tool/toolviews/search-row.tsx
		...
		//#endregion
		//#region ../../../../../tmp/dsh-alpha5-badge-proof-20260903/packages/client/ui-tool/src/client/tool/toolviews/plan-summary.ts
		/**
		...
		*/
		...
		//#endregion
		//#region ../../../../../tmp/dsh-alpha5-badge-proof-20260903/packages/client/ui-tool/src/client/tool/toolviews/todo-row.tsx
		...
		//#endregion
		//#region ../../../../../tmp/dsh-alpha5-badge-proof-20260903/packages/client/ui-tool/src/client/tool/toolviews/web-row.tsx
		...
		//#endregion
		//#region ../../../../../tmp/dsh-alpha5-badge-proof-20260903/packages/client/ui-tool/src/client/apply.ts
