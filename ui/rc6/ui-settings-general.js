window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:/srv/pi-lab-dev/tmp/dsh-ui-proof-rc6-20260905/packages/client/ui-settings-general/src/client/SettingsRoot.module.css.mjs
		const css$3 = ".o8s8ka_trigger{box-sizing:border-box;cursor:pointer;width:calc(100% + 8px);height:34px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:12px;flex:none;align-items:center;gap:8px;margin:4px -4px;padding:6px 2px 6px 10px;font-family:inherit;font-size:14px;line-height:22px;display:flex;overflow:hidden}.o8s8ka_trigger:hover{background:var(--dsw-alias-interactive-bg-hover)}.o8s8ka_trigger.o8s8ka_rail{border-radius:50%;justify-content:center;gap:0;width:36px;height:36px;margin:8px 0 10px;padding:0}.o8s8ka_triggerLabel{white-space:nowrap;overflow:hidden}.o8s8ka_overlay{z-index:1000;justify-content:center;align-items:center;display:flex;position:fixed;inset:0}.o8s8ka_mask{background:var(--dsw-alias-bg-mask-1);backdrop-filter:var(--dsw-mask-blur);position:absolute;inset:0}.o8s8ka_panel{z-index:1;background:var(--dsw-alias-bg-layer-2);width:800px;max-width:calc(100vw - 48px);height:min(800px,100vh - 48px);box-shadow:var(--dsw-shadow-lv3);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:24px;display:flex;position:relative;overflow:hidden}.o8s8ka_nav{box-sizing:border-box;flex-direction:column;flex:none;gap:18px;width:188px;padding:22px 12px 0;display:flex}.o8s8ka_navTitle{color:var(--dsw-alias-label-primary);padding:0 12px;font-size:16px;font-weight:500;line-height:24px}.o8s8ka_navList{flex-direction:column;gap:4px;display:flex}.o8s8ka_navCell{box-sizing:border-box;cursor:pointer;height:40px;color:var(--dsw-alias-label-primary);text-align:left;background:0 0;border:none;border-radius:12px;align-items:center;gap:8px;padding:9px 16px 9px 12px;font-family:inherit;font-size:14px;font-weight:400;line-height:22px;display:flex}.o8s8ka_navCell:hover{background:var(--dsw-specific-sidebar-nav-item-hover)}.o8s8ka_navCell.o8s8ka_active{background:var(--dsw-specific-sidebar-nav-item-active)}.o8s8ka_navIcon{flex:none}.o8s8ka_navLabel{white-space:nowrap;text-overflow:ellipsis;flex:1;min-width:0;overflow:hidden}.o8s8ka_content{flex-direction:column;flex:1;min-width:0;display:flex}.o8s8ka_header{box-sizing:border-box;flex:none;justify-content:space-between;align-items:flex-start;gap:8px;height:54px;padding:20px 14px 8px 10px;display:flex}.o8s8ka_actions{justify-content:flex-end;align-items:center;gap:8px;min-width:0;margin-left:auto;display:flex}.o8s8ka_close{cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:28px;justify-content:center;align-items:center;padding:0;display:inline-flex}.o8s8ka_close:hover{background:var(--dsw-alias-interactive-bg-hover)}.o8s8ka_options{flex:1;min-height:0;padding:0 24px 24px;overflow-y:auto}.o8s8ka_hiddenLabel{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var SettingsRoot_module_css_default = {
			"overlay": "o8s8ka_overlay",
			"close": "o8s8ka_close",
			"content": "o8s8ka_content",
			"panel": "o8s8ka_panel",
			"navIcon": "o8s8ka_navIcon",
			"navList": "o8s8ka_navList",
			"mask": "o8s8ka_mask",
			"actions": "o8s8ka_actions",
			"trigger": "o8s8ka_trigger",
			"hiddenLabel": "o8s8ka_hiddenLabel",
			"navTitle": "o8s8ka_navTitle",
			"nav": "o8s8ka_nav",
			"triggerLabel": "o8s8ka_triggerLabel",
			"header": "o8s8ka_header",
			"navLabel": "o8s8ka_navLabel",
			"navCell": "o8s8ka_navCell",
			"rail": "o8s8ka_rail",
			"active": "o8s8ka_active",
			"options": "o8s8ka_options"
		};
		//#endregion
		//#region ../../../../../tmp/dsh-ui-proof-rc6-20260905/packages/client/ui-settings-general/src/client/SettingsRoot.tsx
		/**
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/srv/pi-lab-dev/tmp/dsh-ui-proof-rc6-20260905/packages/client/ui-settings-general/src/client/chrome.module.css.mjs
		const css$2 = "._IsAIW_triggerLabel{white-space:nowrap;overflow:hidden}";
		...
		var chrome_module_css_default = { "triggerLabel": "_IsAIW_triggerLabel" };
		//#endregion
		//#region ../../../../../tmp/dsh-ui-proof-rc6-20260905/packages/client/ui-settings-general/src/client/chrome.tsx
		/**
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/srv/pi-lab-dev/tmp/dsh-ui-proof-rc6-20260905/packages/client/ui-settings-general/src/client/GeneralSection.module.css.mjs
		const css$1 = ".hVmTxG_section{flex-direction:column;width:100%;display:flex}.hVmTxG_section>[data-slot=\"settings.general.item\"]>:last-child{border-bottom:none}";
		...
		var GeneralSection_module_css_default = { "section": "hVmTxG_section" };
		//#endregion
		//#region ../../../../../tmp/dsh-ui-proof-rc6-20260905/packages/client/ui-settings-general/src/client/GeneralSection.tsx
		/**
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/srv/pi-lab-dev/tmp/dsh-ui-proof-rc6-20260905/packages/client/ui-settings-general/src/client/SettingsDocumentAction.module.css.mjs
		const css = ".GYD58q_action{align-items:center;gap:8px;min-width:0;display:flex}.GYD58q_error{max-width:180px;color:var(--dsw-alias-state-error-primary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:18px;overflow:hidden}";
		...
		var SettingsDocumentAction_module_css_default = {
			"error": "GYD58q_error",
			"action": "GYD58q_action"
		};
		//#endregion
		//#region ../../../../../tmp/dsh-ui-proof-rc6-20260905/packages/client/ui-settings-general/src/client/SettingsDocumentAction.tsx
		...
		*/
		...
		//#endregion
		//#region ../../../../../tmp/dsh-ui-proof-rc6-20260905/packages/client/ui-settings-general/src/client/settings-document-store.ts
		...
		*/
		...
		//#endregion
		//#region ../../../../../tmp/dsh-ui-proof-rc6-20260905/packages/client/ui-settings-general/src/client/locales.ts
		...
		//#endregion
		//#region ../../../../../tmp/dsh-ui-proof-rc6-20260905/packages/client/ui-settings-general/src/client/index.ts
