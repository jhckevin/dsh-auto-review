window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region ../../../../../tmp/dsh-ui-proof-rc6-20260905/packages/client/ui-tool/src/client/tool/models/tool-call-model.ts
		...
		*/
		...
		//#endregion
		//#region ../../../../../tmp/dsh-ui-proof-rc6-20260905/packages/client/ui-tool/src/client/tool/models/read-card-model.ts
		/**
		...
		*/
		...
		//#endregion
		//#region ../../../../../tmp/dsh-ui-proof-rc6-20260905/packages/client/ui-tool/src/client/tool/models/diff-card-model.ts
		/**
		...
		*/
		...
		//#endregion
		//#region ../../../../../tmp/dsh-ui-proof-rc6-20260905/packages/client/ui-tool/src/client/tool/models/search-card-model.ts
		/**
		...
		*/
		...
		//#endregion
		//#region ../../../../../tmp/dsh-ui-proof-rc6-20260905/packages/client/ui-tool/src/client/tool/models/terminal-card-model.ts
		/**
		...
		*/
		...
		//#endregion
		//#region ../../../../../tmp/dsh-ui-proof-rc6-20260905/packages/client/ui-tool/src/client/tool/models/web-card-model.ts
		/**
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/srv/pi-lab-dev/tmp/dsh-ui-proof-rc6-20260905/packages/client/ui-tool/src/client/tool/components/ToolRow.module.css.mjs
		const css$3 = "._1QayXa_root{flex-direction:column;display:flex}._1QayXa_row{position:relative;overflow:hidden}._1QayXa_root[data-state=running] ._1QayXa_row:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite _1QayXa_dsh-tool-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes _1QayXa_dsh-tool-row-sweep{0%{left:-300px}90%,to{left:100%}}._1QayXa_leading{flex-shrink:0}._1QayXa_root[data-tool^=cordis_] ._1QayXa_leading,._1QayXa_root[data-tool^=cordis_] ._1QayXa_title{color:var(--dsw-alias-state-business-primary)}._1QayXa_root[data-tool^=cordis_] ._1QayXa_title{font-weight:500}._1QayXa_root[data-tool^=cordis_] ._1QayXa_sep{background:var(--dsw-alias-state-business-primary)}._1QayXa_chevron{color:var(--dsw-alias-label-secondary)}._1QayXa_title{font-weight:400}._1QayXa_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}._1QayXa_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}._1QayXa_summarySuffix{white-space:nowrap;color:var(--dsw-alias-label-tertiary);flex:none;margin-left:4px;font-size:14px;line-height:24px}._1QayXa_fileLink{text-overflow:ellipsis;white-space:nowrap;min-width:0;font:inherit;text-align:left;color:var(--dsw-alias-label-secondary);text-decoration:underline;text-decoration-color:var(--dsw-alias-label-quaternary);text-underline-offset:3px;cursor:pointer;background:0 0;border:none;flex:auto;margin:0;padding:0;font-size:14px;line-height:24px;overflow:hidden}._1QayXa_fileLink:hover{color:var(--dsw-alias-label-primary);text-decoration-color:currentColor}._1QayXa_errorSummary{color:var(--dsw-alias-state-error-primary)}._1QayXa_bodyWrap{flex-direction:column;display:flex}._1QayXa_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}._1QayXa_root:hover ._1QayXa_inspectButton,._1QayXa_inspectButton:focus-visible{opacity:1}._1QayXa_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}._1QayXa_bodyScroll{max-height:260px;overflow-y:auto}._1QayXa_ioCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}._1QayXa_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}._1QayXa_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}._1QayXa_ioSection::-webkit-scrollbar-track{margin:6px 0}._1QayXa_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}._1QayXa_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:1px}._1QayXa_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}._1QayXa_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}._1QayXa_codeBody,._1QayXa_terminalBody,._1QayXa_diffBody,._1QayXa_readBody,._1QayXa_searchBody,._1QayXa_webBody{margin:4px 0 4px 4px}._1QayXa_searchRecovery{white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-xs-13);color:var(--dsw-alias-label-tertiary);margin:4px 0 4px 4px}._1QayXa_codeBody{--dsl-code-block-content-font:var(--dsw-font-markdown-code-block-small)}._1QayXa_terminalBody{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:1px solid var(--dsw-alias-border-l1)}._1QayXa_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var ToolRow_module_css_default = {
			"codeBody": "_1QayXa_codeBody",
			"webBody": "_1QayXa_webBody",
			"searchBody": "_1QayXa_searchBody",
			"summarySuffix": "_1QayXa_summarySuffix",
			"diffBody": "_1QayXa_diffBody",
			"readBody": "_1QayXa_readBody",
			"root": "_1QayXa_root",
			"summary": "_1QayXa_summary",
			"ioText": "_1QayXa_ioText",
			"dsh-tool-row-sweep": "_1QayXa_dsh-tool-row-sweep",
			"title": "_1QayXa_title",
			"bodyScroll": "_1QayXa_bodyScroll",
			"ioLabel": "_1QayXa_ioLabel",
			"errorSummary": "_1QayXa_errorSummary",
			"ioDivider": "_1QayXa_ioDivider",
			"terminalBody": "_1QayXa_terminalBody",
			"leading": "_1QayXa_leading",
			"row": "_1QayXa_row",
			"chevron": "_1QayXa_chevron",
			"fileLink": "_1QayXa_fileLink",
			"ioSection": "_1QayXa_ioSection",
			"visuallyHidden": "_1QayXa_visuallyHidden",
			"searchRecovery": "_1QayXa_searchRecovery",
			"inspectButton": "_1QayXa_inspectButton",
			"sep": "_1QayXa_sep",
			"bodyWrap": "_1QayXa_bodyWrap",
			"ioCard": "_1QayXa_ioCard"
		};
		//#endregion
		//#region ../../../../../tmp/dsh-ui-proof-rc6-20260905/packages/client/ui-tool/src/client/tool/components/ToolRow.tsx
		...
		*  summary already describe a settled row). */
		...
		//#endregion
		//#region ../../../../../tmp/dsh-ui-proof-rc6-20260905/packages/client/ui-tool/src/client/tool/toolviews/GenericToolCard.tsx
		...
		//#endregion
		//#region \0dsh-css:/srv/pi-lab-dev/tmp/dsh-ui-proof-rc6-20260905/packages/client/ui-tool/src/client/tool/ToolCallTree.module.css.mjs
		const css$2 = ".yP_GJG_callRow{border-radius:6px}.yP_GJG_callLine{align-items:flex-start;display:flex}.yP_GJG_callContent{flex:1;min-width:0}.yP_GJG_badges{flex:none;align-items:center;gap:4px;display:flex}.yP_GJG_badges:empty{display:none}.yP_GJG_subCalls{border-left:1px solid var(--dsw-alias-border-l2);flex-direction:column;gap:4px;margin:4px 0 2px 22px;padding-left:8px;display:flex}";
		...
		var ToolCallTree_module_css_default = {
			"callContent": "yP_GJG_callContent",
			"badges": "yP_GJG_badges",
			"subCalls": "yP_GJG_subCalls",
			"callRow": "yP_GJG_callRow",
			"callLine": "yP_GJG_callLine"
		};
		//#endregion
		//#region ../../../../../tmp/dsh-ui-proof-rc6-20260905/packages/client/ui-tool/src/client/tool/ToolCallTree.tsx
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/srv/pi-lab-dev/tmp/dsh-ui-proof-rc6-20260905/packages/client/ui-tool/src/client/tool/ToolDetails.module.css.mjs
		const css$1 = ".R4mSIq_description{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);margin:0 0 6px}.R4mSIq_cardBody{margin:0}.R4mSIq_recovery{white-space:pre-wrap;overflow-wrap:anywhere;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);margin:6px 0 0}.R4mSIq_code{background:var(--dsw-alias-markdown-code-block);font-family:var(--ds-font-family-code);color:var(--dsw-alias-label-primary);white-space:pre-wrap;word-break:break-word;border-radius:12px;margin:0;padding:16px;font-size:13px;line-height:22px}.R4mSIq_code[data-error]{color:var(--dsw-alias-state-error-primary)}.R4mSIq_read,.R4mSIq_web{margin:0}.R4mSIq_empty{color:var(--dsw-alias-label-tertiary);padding:8px 0;font-size:13px;line-height:20px}";
		...
		var ToolDetails_module_css_default = {
			"code": "R4mSIq_code",
			"description": "R4mSIq_description",
			"cardBody": "R4mSIq_cardBody",
			"empty": "R4mSIq_empty",
			"read": "R4mSIq_read",
			"recovery": "R4mSIq_recovery",
			"web": "R4mSIq_web"
		};
		//#endregion
		//#region ../../../../../tmp/dsh-ui-proof-rc6-20260905/packages/client/ui-tool/src/client/tool/ToolDetails.tsx
		...
		*/
		...
		//#endregion
		//#region ../../../../../tmp/dsh-ui-proof-rc6-20260905/packages/client/ui-tool/src/client/locale.ts
		/** Locale namespace supplied by the conversation owner to Tool renderers. */
		const CONVERSATION_NS = "conversation";
		//#endregion
		//#region ../../../../../tmp/dsh-ui-proof-rc6-20260905/packages/client/ui-tool/src/client/tool/toolviews/ask-question-row.tsx
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/srv/pi-lab-dev/tmp/dsh-ui-proof-rc6-20260905/packages/client/ui-tool/src/client/tool/toolviews/bash-sample.module.css.mjs
		const css = ".trlOmq_card{flex-direction:column;display:flex}.trlOmq_terminal{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:1px solid var(--dsw-alias-border-l1);margin:4px 0 4px 4px}.trlOmq_ioCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}.trlOmq_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}.trlOmq_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.trlOmq_ioSection::-webkit-scrollbar-track{margin:6px 0}.trlOmq_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}.trlOmq_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:1px}.trlOmq_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}.trlOmq_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}.trlOmq_root[data-expandable]{cursor:pointer}.trlOmq_root{align-items:center;min-width:0;height:24px;display:flex;position:relative;overflow:hidden}.trlOmq_root[data-state=running]:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite trlOmq_dsh-bash-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes trlOmq_dsh-bash-row-sweep{0%{left:-300px}90%,to{left:100%}}.trlOmq_leading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:6px;display:inline-flex;position:relative}.trlOmq_chevron{color:var(--dsw-alias-label-secondary)}.trlOmq_iconIdle{opacity:1;transition:opacity .1s;display:inline-flex}.trlOmq_chevronHover{opacity:0;margin:auto;transition:opacity .1s;position:absolute;inset:0}.trlOmq_root:hover .trlOmq_iconIdle{opacity:0}.trlOmq_root:hover .trlOmq_chevronHover{opacity:1}.trlOmq_title{color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px}.trlOmq_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.trlOmq_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.trlOmq_errorSummary{color:var(--dsw-alias-state-error-primary)}.trlOmq_bodyWrap{flex-direction:column;display:flex}.trlOmq_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.trlOmq_card:hover .trlOmq_inspectButton,.trlOmq_inspectButton:focus-visible{opacity:1}.trlOmq_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.trlOmq_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var bash_sample_module_css_default = {
			"title": "trlOmq_title",
			"root": "trlOmq_root",
			"chevron": "trlOmq_chevron",
			"card": "trlOmq_card",
			"inspectButton": "trlOmq_inspectButton",
			"dsh-bash-row-sweep": "trlOmq_dsh-bash-row-sweep",
			"chevronHover": "trlOmq_chevronHover",
			"terminal": "trlOmq_terminal",
			"ioSection": "trlOmq_ioSection",
			"leading": "trlOmq_leading",
			"ioLabel": "trlOmq_ioLabel",
			"errorSummary": "trlOmq_errorSummary",
			"bodyWrap": "trlOmq_bodyWrap",
			"ioDivider": "trlOmq_ioDivider",
			"sep": "trlOmq_sep",
			"ioText": "trlOmq_ioText",
			"iconIdle": "trlOmq_iconIdle",
			"summary": "trlOmq_summary",
			"ioCard": "trlOmq_ioCard",
			"visuallyHidden": "trlOmq_visuallyHidden"
		};
		//#endregion
		//#region ../../../../../tmp/dsh-ui-proof-rc6-20260905/packages/client/ui-tool/src/client/tool/toolviews/bash-sample.tsx
		...
		*/
		...
		//#endregion
		//#region ../../../../../tmp/dsh-ui-proof-rc6-20260905/packages/client/ui-tool/src/client/tool/toolviews/file-mutation-row.tsx
		/**
		...
		*/
		...
		//#endregion
		//#region ../../../../../tmp/dsh-ui-proof-rc6-20260905/packages/client/ui-tool/src/client/tool/toolviews/read-row.tsx
		/**
		...
		*/
		...
		//#endregion
		//#region ../../../../../tmp/dsh-ui-proof-rc6-20260905/packages/client/ui-tool/src/client/tool/toolviews/search-row.tsx
		const SEARCH_TITLES = {
			grep: "Grep",
			glob: "Glob"
		};
		...
		*/
		...
		//#endregion
		//#region ../../../../../tmp/dsh-ui-proof-rc6-20260905/packages/client/ui-tool/src/client/tool/toolviews/plan-summary.ts
		/**
		...
		*/
		...
		//#endregion
		//#region ../../../../../tmp/dsh-ui-proof-rc6-20260905/packages/client/ui-tool/src/client/tool/toolviews/todo-row.tsx
		...
		*/
		...
		//#endregion
		//#region ../../../../../tmp/dsh-ui-proof-rc6-20260905/packages/client/ui-tool/src/client/tool/toolviews/web-row.tsx
		...
		*/
		...
		//#endregion
		//#region ../../../../../tmp/dsh-ui-proof-rc6-20260905/packages/client/ui-tool/src/client/apply.ts
