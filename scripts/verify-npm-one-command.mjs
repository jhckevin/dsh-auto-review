...
try {
  ...
  assert(['rc6', 'rc2', 'alpha5', 'beta', 'next', 'latest'].includes(prepared.distTag))
  if (prepared.dshVersions.length > 1 && prepared.pluginVersion.includes('-rc.')) assert.equal(prepared.distTag, 'next')
